...
serial.onDataReceived(serial.delimiters(Delimiters.NewLine), function () {
    ...
    } else if (受信データ[0] == "S" || 受信データ[0] == "s") {
        rtc.setClockData(clockData.year, parseFloat(受信データ[1]))
        rtc.setClockData(clockData.month, parseFloat(受信データ[2]))
        rtc.setClockData(clockData.day, parseFloat(受信データ[3]))
        rtc.setClockData(clockData.hour, parseFloat(受信データ[4]))
        rtc.setClockData(clockData.minute, parseFloat(受信データ[5]))
        rtc.setClockData(clockData.second, parseFloat(受信データ[6]))
    }
})
